...
const getLandSectionOptions = (office) => {
  const mapping = {
    鹽水地政事務所: [
      ...
      { name: "新厝段", value: "2044" },
      { name: "大腿段", value: "2045" },
      { name: "小腿段", value: "2046" },
      { name: "山子段", value: "2047" },
      { name: "柳營段柳營小段", value: "2048" },
      { name: "柳營段溫厝小段", value: "2049" },
      ...
      { name: "田寮段", value: "2020" },
      { name: "飯店段", value: "2021" },
      { name: "南竹子段", value: "2022" },
      { name: "天保厝段", value: "2023" },
      { name: "頭港段", value: "2024" },
      { name: "北竹子段菜公堂小段", value: "2026" },
      { name: "北竹子段上帝廟小段", value: "2027" },
